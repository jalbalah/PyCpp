...
(1, 2.0);
    ...
    auto {
        s7 = std::vector<std::string>()
        for(auto i = 0; i != 10000000; ++i)
        {
            s7.push_back(std::to_string(i))
        }
        std::ostringstream os1546715761634;
        std::copy(s7.begin(), s7.end() - 1, 
              std::ostream_iterator<decltype(s7[0])>(os1546715761634, ","));
        os1546715761634 << *(s7).rbegin();
        std::string s8 = os1546715761634.str();
;
